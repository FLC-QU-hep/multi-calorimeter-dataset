...
#SBATCH --array=0-999
#SBATCH --job-name=odd_850k
#SBATCH --output=log/odd_850k/inline_%A_%a.out
#SBATCH --error=log/odd_850k/inline_%A_%a.err

# ============================================================================
# ODD ECal inline: simulate → ROOT → H5 → delete ROOT
# 1000 events per job, 850 jobs = 850k events, 1-100 GeV flat energy
# ============================================================================
