...
#SBATCH --array=0-149
#SBATCH --job-name=cld_inl
#SBATCH --output=log/fccee_cld/inline_%A_%a.out
#SBATCH --error=log/fccee_cld/inline_%A_%a.err

# ============================================================================
# FCCee CLD ECal inline: simulate → ROOT → H5 → delete ROOT
# 1000 events per job, 150 jobs = 150k events
# ============================================================================
...
H5_OUTPUT_DIR=$BASE_PATH/output_dataset/$DET_DIR/h5_1M
...
echo "=========================================="
echo "Job: $SLURM_JOB_ID, Task: $SLURM_ARRAY_TASK_ID, BATCH_ID: $BATCH_ID"
echo "$DET inline sim+H5 | N_EVENTS=$N_EVENTS"
echo "=========================================="
...
export WORK_DIR
export CLD_COMPACT=$WORK_DIR/k4geo/FCCee/CLD/compact/FCCee_o2_v04/FCCee_o2_v04.xml

STEERING=$WORK_DIR/ddfastsim/options/FCCeeCLD/FCCeeCLD_ddsim_steer_steps_lcio.py
SLCIO=$TMP_DIR/${DET}_${PADDED}.slcio
ROOT_FILE=$TMP_DIR/${DET}_${PADDED}.root

echo "Step 1: Generating MC particles..."
