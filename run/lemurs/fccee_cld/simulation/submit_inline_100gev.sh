...
#SBATCH --array=0-849
#SBATCH --job-name=cld_100gev
#SBATCH --output=log/fccee_cld_100gev/inline_%A_%a.out
#SBATCH --error=log/fccee_cld_100gev/inline_%A_%a.err

# ============================================================================
# FCCee CLD ECal inline: simulate → ROOT → H5 → delete ROOT
# 1000 events per job, 1-100 GeV flat energy
# 850 jobs (850k events) to add to existing 150k
# ============================================================================
