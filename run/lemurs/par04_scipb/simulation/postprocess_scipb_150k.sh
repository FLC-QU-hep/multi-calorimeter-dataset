...
#SBATCH --job-name=scipb_postproc
#SBATCH --output=log/par04_scipb_100gev/postprocess_%j.out
#SBATCH --error=log/par04_scipb_100gev/postprocess_%j.err

# ============================================================================
# Par04_SciPb 150k post-processing: merge → AllShowers finetune → PointCountFM
# ============================================================================
...
mkdir -p $ALLSHOWERS/finetune_par04_scipb
cp $MERGED $ALLSHOWERS/finetune_par04_scipb/${DET}_110k.h5
echo "Copied to $ALLSHOWERS/finetune_par04_scipb/${DET}_110k.h5"
...
python3 scripts/lemurs/create_cond.py \
    ...
    --src $MERGED \
    --n 10000 \
    --output finetune_par04_scipb/${DET}_10k_cond.h5

if [ ! -f "$ALLSHOWERS/finetune_par04_scipb/${DET}_10k_cond.h5" ]; then
    echo "FAILED: conditioning file not created"
    exit 2
fi
echo "Created: $(ls -lh $ALLSHOWERS/finetune_par04_scipb/${DET}_10k_cond.h5 | awk '{print $5}')"
...
echo "  Merged:       $MERGED"
echo "  AllShowers:   $ALLSHOWERS/finetune_par04_scipb/${DET}_110k.h5"
echo "  Cond:         $ALLSHOWERS/finetune_par04_scipb/${DET}_10k_cond.h5"
